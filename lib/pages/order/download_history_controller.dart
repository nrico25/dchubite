...
class DownloadHistoryController extends GetxController with WidgetsBindingObserver {
...
void showLoadingSnackbar() {
  CustomSnackbar(
    title: "Mengunduh...",
    message: "Mohon tunggu, laporan sedang diunduh.",
    ...
    showProgress: true, // tambahin di CustomSnackbar kalau mau ada indikator
  ).show();
}
  ...
  Future<void> downloadAllHistory() async {
    ...
    final file = await OrderService.downloadAllHistory(token);
  ...
  Future<void> downloadWeeklyHistory() async {
    try {
       isDownloading.value = true;
    ...
    String token = authController.token.value;
    final file = await OrderService.downloadWeeklyHistory(token);
  ...
  Future<void> downloadMonthlyHistory() async {
    try {
     isDownloading.value = true;
    ...
    String token = authController.token.value;
    final file = await OrderService.downloadMonthlyHistory(token);
